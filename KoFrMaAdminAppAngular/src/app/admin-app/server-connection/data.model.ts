...
export class Data
{
    ...
    public Permissions : PermInterface[] = [{name:'Add Admins', number:1}, {name: 'Add Tasks', number:2}, {name: 'Change Table Data', number: 3}, {name: 'Change Permissions', number: 4}, {name: 'Change Passwords', number: 5}];
}